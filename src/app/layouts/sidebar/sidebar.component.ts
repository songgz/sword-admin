...
export class SidebarComponent implements OnInit, AfterViewInit{
  ...
  constructor(private router: Router, private rest: RestApiService) {
    ...
    this.rest.get('menu_items').subscribe(data => {
      this.menuItems = data.data;
      this.root =  this.menuItems.find(item => item.sign === 'sys-menu');
      console.log(this.root);
    });
  }

  getSubMenuItem(parent_id: String) :any[] {
    return this.menuItems.filter(item => item.parent_id === parent_id );
